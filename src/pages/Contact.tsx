            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white p-8 rounded-lg shadow-md">
                  <h2 className="text-2xl font-bold mb-6 text-abbaquar-purple">Send us a message</h2>
              ...
              <div>
                <div className="bg-white p-8 rounded-lg shadow-md mb-8">
                  <h2 className="text-2xl font-bold mb-6 text-abbaquar-purple">Contact Information</h2>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">info@abbaquar-sandreamcentre.co.za</p>
                      </div>
                    </div>
                ...
                <div className="bg-white p-8 rounded-lg shadow-md">
                  <h2 className="text-2xl font-bold mb-6 text-abbaquar-purple">Service Times</h2>
