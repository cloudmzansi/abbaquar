    ...
    <section className="py-24 bg-gradient-to-b from-[#073366] to-[#0A2647]">
      <div className="container-custom">
        <div className="text-center mb-16">
          <span className="text-[#8A4BA3] font-semibold mb-4 block">Get In Touch</span>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-3xl p-8 shadow-2xl">
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      ...
                      autoComplete="name"
                      className="w-full px-6 py-4 text-lg border-2 rounded-xl focus:outline-none focus:border-[#8A4BA3] transition-all"
                      required
                ...
                <button 
                  type="submit" 
                  className="w-full bg-[#8A4BA3] text-white px-8 py-4 rounded-xl font-semibold text-lg hover:bg-opacity-90 transition-all transform hover:scale-105 flex items-center justify-center"
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <MapPin className="h-6 w-6 text-[#8A4BA3]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <Phone className="h-6 w-6 text-[#8A4BA3]" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-white/10 p-3 rounded-xl">
                    <Mail className="h-6 w-6 text-[#8A4BA3]" />
                  </div>
                  <div>
