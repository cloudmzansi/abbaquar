const About = () => {
  return (
    <section id="about" className="section-padding mb-16">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-xl font-semibold mb-4 text-[#073366]">The Royal House</h3>
            ...
            <h3 className="text-xl font-semibold mb-4 text-[#073366]">Community</h3>
            <p className="text-[#073366] mb-6">
